...
class ProductTest {
    ...
    void electronics_regular_noOtherDiscounts() {
        Product p = new Product("Laptop", "Electronics", 1000, 1);
        double total = p.getTotal("Regular", false, 0);
    ...
    void electronics_premium_noOtherDiscounts() {
        Product p = new Product("Laptop", "Electronics", 1000, 1);
        double total = p.getTotal("Premium", false, 0);
    ...
    void electronics_vip_noOtherDiscounts() {
        Product p = new Product("Laptop", "Electronics", 1000, 1);
        double total = p.getTotal("VIP", false, 0);
    ...
    void clothing_regular_holiday() {
        Product p = new Product("Shirt", "Clothing", 100, 1);
        double total = p.getTotal("Regular", true, 0);
    ...
    void clothing_premium_holiday() {
        Product p = new Product("Shirt", "Clothing", 100, 1);
        double total = p.getTotal("Premium", true, 0);
    ...
    void clothing_vip_holiday() {
        Product p = new Product("Shirt", "Clothing", 100, 1);
        double total = p.getTotal("VIP", true, 0);
    ...
    void food_quantityUnder10_regular() {
        Product p = new Product("Apple", "Food", 10, 5);
        double total = p.getTotal("Regular", false, 0);
    ...
    void food_quantity10OrMore_regular_bulkApplies() {
        Product p = new Product("Apple", "Food", 10, 10);
        double total = p.getTotal("Regular", false, 0);
    ...
    void food_vip_quantity10() {
        Product p = new Product("Apple", "Food", 50, 10);
        double total = p.getTotal("VIP", false, 0);
    ...
    void loyalty1000_vip() {
        Product p = new Product("Laptop", "Electronics", 1000, 1);
        double total = p.getTotal("VIP", false, 1000);
    ...
    void loyalty1000_premium() {
        Product p = new Product("Widget", "Other", 100, 1);
        double total = p.getTotal("Premium", false, 1000);
    ...
    void loyalty1000_regular() {
        Product p = new Product("Widget", "Other", 100, 1);
        double total = p.getTotal("Regular", false, 1000);
    ...
    void loyalty500_premium() {
        Product p = new Product("Shirt", "Clothing", 100, 1);
        double total = p.getTotal("Premium", false, 500);
    ...
    void loyalty500_vip() {
        Product p = new Product("Widget", "Other", 100, 1);
        double total = p.getTotal("VIP", false, 500);
    ...
    void loyalty500_regular_noDiscount() {
        Product p = new Product("Widget", "Other", 100, 1);
        double total = p.getTotal("Regular", false, 500);
    ...
    void loyalty999_premium_getsDiscount() {
        Product p = new Product("Widget", "Other", 100, 1);
        double total = p.getTotal("Premium", false, 999);
    ...
    void loyalty999_regular_noDiscount() {
        Product p = new Product("Widget", "Other", 100, 1);
        double total = p.getTotal("Regular", false, 999);
        assertEquals(100, total, DELTA);
    }
    ...
    void loyalty499_vip_noDiscount() {
        Product p = new Product("Widget", "Other", 100, 1);
        double total = p.getTotal("VIP", false, 499);
        assertEquals(100, total, DELTA);
    }
    ...
    void loyalty499_premium_noDiscount() {
        Product p = new Product("Widget", "Other", 100, 1);
        double total = p.getTotal("Premium", false, 499);
        assertEquals(100, total, DELTA);
    }
    ...
    void bulk20_quantityDiscount() {
        Product p = new Product("Widget", "Other", 10, 20);
        double total = p.getTotal("Regular", false, 0);
    ...
    void bulk10_quantityDiscount() {
        Product p = new Product("Widget", "Other", 10, 10);
        double total = p.getTotal("Regular", false, 0);
        // base 100, bulk 10 → 97
        assertEquals(97, total, DELTA);
    }
    ...
    void tax_electronics() {
        Product p = new Product("Laptop", "Electronics", 100, 2);
        assertEquals(20, p.getTax("Regular"), DELTA); // 200 * 0.1
    }

    @Test
    void tax_clothing() {
        Product p = new Product("Shirt", "Clothing", 100, 1);
        assertEquals(8, p.getTax("Regular"), DELTA); // 100 * 0.08
    }

    @Test
    void tax_food_vip() {
        Product p = new Product("Apple", "Food", 100, 1);
        assertEquals(5, p.getTax("VIP"), DELTA); // 100 * 0.05
    }

    @Test
    void tax_food_regular() {
        Product p = new Product("Apple", "Food", 100, 1);
        assertEquals(10, p.getTax("Regular"), DELTA); // 100 * 0.1
    }

    @Test
    void tax_otherCategory_zero() {
        Product p = new Product("Widget", "Other", 100, 1);
        assertEquals(0, p.getTax("Regular"), DELTA);
    }
}
