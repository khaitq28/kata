...
class ProductTest {
    ...
    void electronics_regular_noOtherDiscounts() {
        ...
        double total = p.getTotal(new DiscountContext(CustomerType.REGULAR, false, 0));
    ...
    void electronics_premium_noOtherDiscounts() {
        Product p = new Product("Laptop", Category.ELECTRONICS, 1000, 1);
        double total = p.getTotal(new DiscountContext(CustomerType.PREMIUM, false, 0));
    ...
    void electronics_vip_noOtherDiscounts() {
        Product p = new Product("Laptop", Category.ELECTRONICS, 1000, 1);
        double total = p.getTotal(new DiscountContext(CustomerType.VIP, false, 0));
    ...
    void clothing_regular_holiday() {
        ...
        double total = p.getTotal(new DiscountContext(CustomerType.REGULAR, true, 0));
    ...
    void clothing_premium_holiday() {
        Product p = new Product("Shirt", Category.CLOTHING, 100, 1);
        double total = p.getTotal(new DiscountContext(CustomerType.PREMIUM, true, 0));
    ...
    void clothing_vip_holiday() {
        Product p = new Product("Shirt", Category.CLOTHING, 100, 1);
        double total = p.getTotal(new DiscountContext(CustomerType.VIP, true, 0));
    ...
    void loyalty1000_vip() {
        Product p = new Product("Laptop", Category.ELECTRONICS, 1000, 1);
        double total = p.getTotal(new DiscountContext(CustomerType.VIP, false, 1000));
    ...
    void loyalty1000_premium() {
        ...
        double total = p.getTotal(new DiscountContext(CustomerType.PREMIUM, false, 1000));
    ...
    void loyalty1000_regular() {
        Product p = new Product("Widget", Category.OTHER, 100, 1);
        double total = p.getTotal(new DiscountContext(CustomerType.REGULAR, false, 1000));
    ...
    void loyalty500_premium() {
        Product p = new Product("Shirt", Category.CLOTHING, 100, 1);
        double total = p.getTotal(new DiscountContext(CustomerType.PREMIUM, false, 500));
    ...
    void loyalty500_vip() {
        Product p = new Product("Widget", Category.OTHER, 100, 1);
        double total = p.getTotal(new DiscountContext(CustomerType.VIP, false, 500));
    ...
    void loyalty500_regular_noDiscount() {
        Product p = new Product("Widget", Category.OTHER, 100, 1);
        double total = p.getTotal(new DiscountContext(CustomerType.REGULAR, false, 500));
    ...
    void loyalty999_premium_getsDiscount() {
        Product p = new Product("Widget", Category.OTHER, 100, 1);
        double total = p.getTotal(new DiscountContext(CustomerType.PREMIUM, false, 999));
    ...
    void loyalty999_regular_noDiscount() {
        Product p = new Product("Widget", Category.OTHER, 100, 1);
        double total = p.getTotal(new DiscountContext(CustomerType.REGULAR, false, 999));
        assertEquals(100, total, DELTA);
    }
    ...
    void loyalty499_vip_noDiscount() {
        Product p = new Product("Widget", Category.OTHER, 100, 1);
        double total = p.getTotal(new DiscountContext(CustomerType.VIP, false, 499));
        assertEquals(100, total, DELTA);
    }
    ...
    void loyalty499_premium_noDiscount() {
        Product p = new Product("Widget", Category.OTHER, 100, 1);
        double total = p.getTotal(new DiscountContext(CustomerType.PREMIUM, false, 499));
        assertEquals(100, total, DELTA);
    }
    ...
    void tax_electronics() {
        ...
        assertEquals(20, p.getTax(new DiscountContext(CustomerType.REGULAR, false, 0)), DELTA); // 200 * 0.1
    }

    @Test
    void tax_clothing() {
        Product p = new Product("Shirt", Category.CLOTHING, 100, 1);
        assertEquals(8, p.getTax(new DiscountContext(CustomerType.REGULAR, false, 0)), DELTA); // 100 * 0.08
    }

    @Test
    void tax_food_vip() {
        Product p = new Product("Apple", Category.FOOD, 100, 1);
        assertEquals(5, p.getTax(new DiscountContext(CustomerType.VIP, false, 0)), DELTA); // 100 * 0.05
    }

    @Test
    void tax_food_regular() {
        Product p = new Product("Apple", Category.FOOD, 100, 1);
        assertEquals(10, p.getTax(new DiscountContext(CustomerType.REGULAR, false, 0)), DELTA); // 100 * 0.1
    }

    @Test
    void tax_otherCategory_zero() {
        Product p = new Product("Widget", Category.OTHER, 100, 1);
        assertEquals(0, p.getTax(new DiscountContext(CustomerType.REGULAR, false, 0)), DELTA);
    }
}
